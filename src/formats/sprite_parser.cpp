...
Sprite SpriteParser::parse(const std::vector<uint8_t>& data)
{
    ...
    {
        logger.error("Sprite data is smaller than sprite header");
        return sprite;
    }
    ...
    {
        logger.error("Not enough data for sprite palette");
        return sprite;
    }
    ...
    for (int i = 0; i < header->frameCount; i++)
    {
        ...
        {
            logger.error("Not enough data for sprite frame info");
            return sprite;
        }
        ...
        {
            logger.error("Not enough data for sprite frame data");
            return sprite;
        }
